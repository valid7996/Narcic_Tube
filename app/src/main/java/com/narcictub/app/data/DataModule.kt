...
import com.narcictub.app.data.resolver.YouTubeExtractor
...
abstract class DataBindsModule {
    ...
    /** PHASE 24: YouTube intake — feasibility verdict applied, zero network. */
    @Binds
    @IntoSet
    abstract fun bindYouTubeExtractor(impl: YouTubeExtractor): MediaExtractor
